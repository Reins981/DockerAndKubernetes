...
app.post('/signup', async (req, res) => {
  ...
  try {
    // AUTH_SERVICE is automatically set by Kubernetes as DNS name (holds the IP address ) of the service, which is the service name in the YAML file (upper case and - replaced by _)
...
app.post('/login', async (req, res) => {
  ...
  // Alternative is to use a manual envirnoment variable
